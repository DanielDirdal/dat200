...
# Sett inn (verdi, prioritet) tupler i lista, sett inn på slutten

# For peek og remove, leit gjennom lista etter det minste elementer og returner det.
...
class Prioritetsko:
    ...
    # Finner indeksen i lista til det laveste elementet
    # Kjøretid Theta(n)
    ...
    # Tar ut og returnere verdien med lavest verdi i "prioritet" variabelen
    # Kjøretid: Theta(n)
    def remove(self):
        if len(self.liste) == 0:
